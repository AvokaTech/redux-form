  ...
  return function (initialConfig) {
    ...
    return function (WrappedComponent) {
      ...
      var Form = function (_Component) {
        ...
        _createClass(Form, [{
          ...
          value: function validateIfNeeded(nextProps) {
            ...
            var shouldValidate = _props2.shouldValidate;
          ...
          value: function render() {
            ...
            var shouldValidate = _props7.shouldValidate;
            ...
            var rest = _objectWithoutProperties(_props7, ['anyTouched', 'arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncErrors', 'asyncValidate', 'asyncValidating', 'blur', 'change', 'destroy', 'destroyOnUnmount', 'dirty', 'dispatch', 'enableReinitialize', 'error', 'focus', 'form', 'getFormState', 'initialize', 'initialized', 'initialValues', 'invalid', 'keepDirtyOnReinitialize', 'pristine', 'propNamespace', 'registeredFields', 'registerField', 'reset', 'setSubmitFailed', 'setSubmitSucceeded', 'shouldAsyncValidate', 'shouldValidate', 'startAsyncValidation', 'startSubmit', 'stopAsyncValidation', 'stopSubmit', 'submitting', 'submitFailed', 'submitSucceeded', 'touch', 'touchOnBlur', 'touchOnChange', 'persistentSubmitErrors', 'syncErrors', 'syncWarnings', 'unregisterField', 'untouch', 'updateSyncErrors', 'updateSyncWarnings', 'valid', 'values', 'warning']);
      ...
      var connector = (0, _reactRedux.connect)(function (state, props) {
        ...
        var keepDirtyOnReinitialize = props.keepDirtyOnReinitialize;
